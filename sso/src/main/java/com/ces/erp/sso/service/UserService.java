...
import com.ces.erp.sso.pojo.User;
import com.ces.erp.sso.repository.JedisClient;
import com.ces.erp.sso.repository.UserRepository;
import com.ces.erp.sso.utils.CommonUtils;
import com.ces.erp.sso.utils.CookieUtils;
import com.ces.erp.sso.utils.JsonUtils;
...
public class UserService {
    ...
    public ResultInfo userLogin(String account, String password,
        ...
        // 判断账号密码是否正确
        User user = userRepository.findByLoginName(account);
